...
const LoginComponent = ({ onLogin }) => {
  ...
  let link = Unzer.config.store.mode === 'live' ? Unzer.translationService.translate("credentials.linkLive")
  ...
  const envField = Unzer.components.RadioButtonGroupField.create({
    ...
    onChange: (value) => {
      ...
      let link = value === 'live' ? Unzer.translationService.translate("credentials.linkLive")
          : Unzer.translationService.translate(
              "credentials.linkSandbox");
