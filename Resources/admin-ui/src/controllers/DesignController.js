Unzer.DesignController = function () {
    ...
    const render = () => {
                ...
                button: Unzer.components.Button.createList([
                    {
                        ...
                        onClick: () => {
                            if (validateColorFields() && (!selectedValues.logoImageUrl || validateUrlFields(
                                    urlField,
                                    selectedValues.logoImageUrl
                                )) &&
                                (!selectedValues.backgroundImageUrl || validateUrlFields(
                                    backgroundImageField,
                                    selectedValues.backgroundImageUrl
                                ))) {
                                createPreviewPage();
                            }
                        }
        ...
        const fontField = generator.createElement('div', 'unzer-input-wrapper-padding', '', null, [
